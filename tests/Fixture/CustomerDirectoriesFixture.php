...
/**
 * CustomerDirectoriesFixture
 *
 */
class CustomerDirectoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'directory_firm' => ['type' => 'foreign', 'columns' => ['firm_id'], 'references' => ['firms', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
